...
In contrast, our other honeymoon was an epic three weeks in Japan. We starte out in Tokyo, then moved
...
What spoiled it for me was the GitHub Mac team shipped Carthage which stuck around and fragmented the ecosystem. Then a
couple of months later Apple announced their own dependency manger which deprecated both Carthage and CocoaPods. This is
old new nows as it was two years ago, but the Swift Package Manager doesn't actually deprecate CocoaPods, because it
doesn't handle any of the problems people have. This sucks.
...
your dependants aren't static. Luckily, there's fresh blood in the project, Dimitris

**JS Infrastructure** - Artsy moved more of our native focus to JavaScript, we needed to ensure that a lot of the
fuzzier edges of JavaScript were hardened. This ranges from feeling confident in the lifetime all of our key
dependencies, to being confident that Artsy

**Danger** - TBH Danger is worth it;s own whole section.
...
[active]: https://gist.github.com/paulmillr/2657075/ [millions]: http://metrics.cocoapods.org/api/v1/status
