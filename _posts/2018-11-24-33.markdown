...
something bigger than the last two conferences I ran: I'd want it to be like Brazil JS. [My talk][br-talk]
...
I decided I wanted to underestand how folks did the gym. I bought a membership, but mostly just ran so when
