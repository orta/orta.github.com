...
- [A bleak look at the state of tech culture](/on/spoiling/tech)
...
from A to B quickly. This is working out pretty well, I skateboard to the local climbing gym 2-3 times a week which I
think is a nice synergy.
...
maintaining) and _Thing_.

That goal was in part because I figured it was likely that _Thing_ might turn into something which needed full time
attention. I can't really talk about it yet, but that ended up the case - some of that was just good luck but another

This year I left Microsoft, to go full time on _Thing_. I had intended on trying to take a year out to slow down and do
community open source programming, catch up on some reading and try to decompress. When I balanced that out with the
...
The list of books above are work. So, in-between I read three separate stories.

[A little Hatred](https://www.books.ie/a-little-hatred) is probably a bit too close to the above books for comfort. It's
kinda like Game of Thrones but with class warfare due to an industrial revolution as the main plot pushing force. A good
book, slightly cathartic but pretty stressful.

[The Quantum Thief](https://en.wikipedia.org/wiki/The_Quantum_Thief) trilogy is an aphant computer person's dream book
series. Honestly, it's starting to replace Worm as my favourite book. This was my comfort re-read, and it's the most
idea-dense book I have read. It's not something I'd universally recommend (unlike Worm) because of that density, but if
you know computers this book could really resonate. It's set in a post-singularity universe where multiple approaches to
'uploading consciousness' are at war across the solar system. The re-read was some of the best experiences I had
in 2022. I knew the characters, I knew the terminology and I could just bask in the complexity of the story and ideas.

[Gnomon](<https://en.wikipedia.org/wiki/Gnomon_(novel)>) is inception with stories instead of dreams. It's also very
complex, and its kind of a book which makes you feel clever if you're keeping up with it. I had tried to read the book a
few years back and bounced of - but 2022 was the year to try again. I enjoyed it, it is a recursive detective novel
about identity.

[Ward](https://www.parahumans.net) is the sequel to Worm, I've got pretty far into it but it didn't stick. Maybe 2023?

#### Games

- [It Takes Two](https://www.ea.com/games/it-takes-two) was our favourite game to play. It's a kickass two-player game.
- [Horzizon Zero Dawn](https://www.ea.com/games/horizon-zero-dawn) is a great open world game. Loved it, compelling
  story and the sequel is coming out in 2022. I've had a 17 year embargo on Sony products (the
  [CD rootkits](https://en.wikipedia.org/wiki/Sony_BMG_copy_protection_rootkit_scandal)) I grabbed the game on a Steam
  deal before realizing it was a Sony game.

- [HITMAN](https://hitman.com/global/) was a game I skipped many times because I thought it was super serious. I was
  wrong. It presents itself as a very serious James Bond game, but it's actually a very good game. I enjoyed it, and
- Forza
- Cyberpunk

#### TV

- [On Becoming a God in Central Florida](https://www.imdb.com/title/tt6398232/)
- [Dopesick](https://www.imdb.com/title/tt9174558/)
- Rewatched [Dark](https://www.imdb.com/title/tt5753856/)
- Squid Games
...
This writeup is still being worked on in mid-April 2022. Which is going to make the next one a nightmare to figure out
when stuff happened. We've got to know our Dublin neighbors, fostered a tonne of dogs and are currently hosting some
Ukrainian folks.

It's been significantly harder to find motivation to work on this writeup for a range of reasons like 'it's not fun to
write this stuff' to 'I have to build _Thing_' which is taking up an incredible amount of mind-space for me. I even
dropped a few sub-pages talking about how bleak politics and climate change looks in the 21st century. In the end I've
opted to just ship this thing half-done so at least I can start again for next year.

[Kurzgesagt said roughly](https://www.youtube.com/watch?v=LxgMdjyw8uw) that despair is the last weapon people in power
have against change they don't want to see. That said, I don't think capitalism can fix the problems of growth which
capitalism creates.
