...
* [Intelligence Augmentation][8], coming from [Douglas Englebart][9], which is mainly focused making it easier for humans to make better decisions.
...
Over the course of the year, we completed a few games, I feel like the one we put the most time into was The Binding of Isaac. I put a few hundred hours in to Team Fortress 2 this year, don’t worry, I’ve got a [rare coin thing][14] for my time.
...
I’m 4 years into Artsy, and we’ve hit the [dunbar number][15] this year.
...
To quote “[on being 28][16]”

> Dropping the team down to one was a bit of a bummer. However, I got a promotion of sorts as I was the only one left.

It’s like night and day now. I study management styles like I used to study programming languages. I’d recommend reading [Tribal Leadership][17], [The Year Without Pants][18] and [Leadership and self-deception][19]. Artsy is big enough to have politics, and I find it interesting to be a part of that.

We spent the time on building team foundations like the [article in objc.io][20] helping us understand how we see ourselves. We’re a confident team, shipping code in the open.

This time last year, we had only just started down the path to [Open By Default][21]. Now that’s complete. With help from the rest of the team we successfully opened the entire development process for every Artsy iOS app.
...
> I worry that my ability to jump in and just do what it takes can negatively affect the future culture of the Artsy mobile team. Perhaps we need more [Gordian Knot][22] style answers for these things. I must work on this.

I’m much happier about where we are at with this. There was nothing like the launch of [Eidolon][23], people are/were free to devote their time as [they please][24], but at no point this year was a crunch absolutely necessary.
...
As a team there’s been a bunch of solid releases, and the command-line gem has improved a lot, there’s an annual write-up on the blog now, [see 2015][25].

---- 

Alright, so let’s take a look over the year:

I tried to make myself nervous on my 28th birthday. Danger + I went to a casino, I gave myself a hard limit of being able to lose up-to £1,000. We played on the roulette table all night, I had been [practicing Blackjack][26] for a bit, and was pretty comfortable with it, but the tables were all busy. By playing slow, not making silly moves we ended up coming out with £500 from the house. Deciding that was enough and you can’t win forever, we went [for Pizza][27], and  put the rest of the cash towards a car.

Oddly enough, my calendar is completely empty throughout Dec -\> Feb. I did no talks, I helped out in shipping Swift support from the perspective of CP infrastructure, I started writing a book on testing in iOS projects and took a look at automating some of the 

NYC?
* DM over in feb, september and november
* VISA renewed? O1? DM?
...
[14]:	http://www.tf2items.com/id/orta#tab-backpack
[15]:	https://en.wikipedia.org/wiki/Dunbar%27s_number
[16]:	http://orta.github.com/on/being/28
[17]:	tribbey
[18]:	panks
[19]:	leadyy
[20]:	objcio
[21]:	dblock?%20mtself?%20video?
[22]:	https://en.wikipedia.org/wiki/Gordian_Knot
[23]:	28%20link?%20maybe
[24]:	jobs%20post?
[25]:	http://blog.cocoapods.org/Stats-2015/
[26]:	http://gizmodo.com/5973547/download-this-app-and-learn-to-play-blackjack
[27]:	https://www.facebook.com/pages/Bar-Maroc/182124065217984