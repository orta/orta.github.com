...
Brooklyn on the other hand is homely, spacious and well lived-in. It's a predominantly black borough. I get there are
economic arguments for why gentrification happens (if so many people want to live near Manhattan eventually everything
in transit distance will end up with Manhattan prices) but it's one thing to think about gentrification as a concept,
it's another to walk outside and see yet more local non-white businesses being replaced with a hipster barber place run
by white folks.
...
experiment, I've never really had time for that because I want what little spare time I do have to have the most
cultural value.
