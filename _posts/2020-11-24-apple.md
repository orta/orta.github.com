...
At heart, I don't find a phone to be a useful device for me. When I'm not at a computer I don't want to be instantly
available to others, nor do I use a phone as a media consuming device. The lsat 5 years of Mac changes being about
accomodating iOS devices have been basically changes which don't affect me.

Today, I have an android device which I use to occasionally play tower defense games, and I wish that Android had an app
as good a Twitter client as Tweetbot - the only iOS app I really used regularly.
...
I must stress, for most Mac users these are good things. They don't need a fully general purpose computer, it seems most
...
are a trap to me. Which has meant I've moved off more native software over the last few years.

I do think there's still a space for optimized native single platform software on the desktop (Sketch, Paw, Pixen, Nova
and Screenflow being great examples) but they are progressively becoming more and more niche. Apple knows this, and the
Mac has slowly become a better platform for time-cheap iOS ports instead.
