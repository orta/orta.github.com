...
mainly just a time thing, and she's got this.
...
- I have a new manager for the first time, who I don't really share much in common with. We both just have different
  ...
  me. This was compounded as we went from being 3 levels of managerial deep `(IC -> Manager -> CTO)` to 4
  `(IC -> Manager -> VP -> CTO)` which also meant I lost some useful 1-on-1s with C-level execs were cancelled.

  I don't really want to end up in a place where someone else is responsible for deciding what to do my time, or my
  career. Unlike the above, I think this is somewhat unreasonable, but not really something I'm willing to give up. It's
  likely a something this year ended up bringing to the table.
...
- 2018 went from me enjoying working with everyone, to pushing that I wanted to work in a particular team based on
  ...
  any other way. But, it grates, and is a source of friction once every week or two.
