...
I expect 2018 will be dominated by helping her move, and helping her get settled and finding her feet. This should be quite a lot of fun, I've reduced a lot of my larger responsibilities and am continuing in that direction so that we can start with Danger having a great introduction to NYC. Instead of me always on a laptop working on some community project.
...
* Visual Studio Code
* Testing via Jest
* Typing JavaScript via Flow, and TypeScript
