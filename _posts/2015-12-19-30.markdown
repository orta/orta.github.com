...
It's hard to remember the specifics of why I [wrote this](http://orta.io/rebase/impact/), but it was around the CocoaPods 1.0 launch where I was turning down a lot of offers to social stuff do in order to ship a lot of software. It worried Danger.
...
The TLDR: a lot of the tooling has so much potential. The fact that everything is open means that they all kind of work together and it's up to you to figure out how to make the jigsaw of small pieces fit. I've found a lot of places where a tiny bit of effort can really make a strong different to the editing experience. I've writing a lot about this on the [Artsy blog](http://artsy.github.io/author/orta/) so it's exploration here should be short. 
...
This is because [Alloy][] put forward [that React Native][], should be the way in which Artsy handles mobile. It's hard to overstate the change that this is. I wanted to be a Mac developer since I started to program, I have wrote Objective-C and native apps for a decade and this year that changed.

The reasons for this is a general discomfort with the current status-quo around building apps. It does not feel like it's in Apple's interests to change either. Long explaination for that is here:
...
I came into this with relatively little expectations and was blown away. I'm afraid by me saying this I've raised that bar, but a lot of people have now read it in Artsy and love it.
...
As I have a VR setup, people ask if porn on VR is going to be the next big thing. Porn doesn't really a thing on VR yet, it's pretty bad right now. The most interesting bit to me is that [PornHub is producing their own][pornhub] content. It's a bit like when Netflix started making their own series. Could bring a lot of changes.

VR is obviously at very early adopters stage, but I can't help feeling that serious adoption just won't happen. People don't like the idea of being totally enclosed and ignoring all external input, when I get out of being in VR into a dark room - it feels [really dystopian](http://i.imgur.com/odweUkw.jpg). When I demo it to others though, they tend to be impressed.

-   [Overwatch](https://www.twitch.tv/directory/game/Overwatch)

I [played TF2][tf2] for years. I played in leagues back when I was 21/22 but once I moved to Huddersfield (and left my Windows computer behind) I never really got back into these kind of games. [Overwatch changed that](http://www.eurogamer.net/articles/2016-12-31-eurogamers-game-of-the-year-2016). It offered a more fresh, modern take on the root concept of TF2 with a lot less machoism.

I've really been enjoying Overwatch, I can take it seriously when I need to - and take it not when I don't. The genre of "[Hero Shooter][]" is great, because I prefer to play as a supporting character. I love being healer classes, standing slightly behind making sure everyone else is in optimum setup. TF2 used to be the only game that I could really do that in, now there's also Overwatch.
...
Definitely the most meta game I've played, and Dangers favourite game this year. There was this one point that really started to screw with my "is this a game?" perception, that I definitely won't talk about.
...
I love working with the people I get to at Artsy, and on the projects that I think matter. [dB](http://www.dblock.org) continues to push me into spaces I'm uncomfortable, and I'm 👍 with that.
...
For Artsy, the biggest singular project I helped shipped this year was [Live Auctions on iOS](http://theartnewspaper.com/market/artsy-partners-with-phillips-and-koller-auction-houses-on-live-bidding/).
...
I [do](https://github.com/orta/) somewhere between 10-20 [code review][] sessions a day. At that start of 2015, I wanted something to automate parts of our team workflow becase the Artsy mobile team was growing. We were looking to cover some of the simplest code review steps e.g. writing CHANGELOGs in an automatic way.

I spent a long time trying to pursuade others to make something to do this. I failed though, so Danger [was started](https://github.com/danger/danger/commit/54bff6406a9f3a880f00e14c13a2314f9e7173e0) in September 2015, but didn't get a mention in [On Being 29][29]. This makes sense, I may have started the project then, but work [only really started](https://github.com/danger/danger/releases?after=v0.1.1) in January 2016 when [Felix Krause started to help](https://github.com/danger/danger/compare/v0.1.0...0.1.1) after a trip to NYC.

Explaining Danger, the software projects, is fun. I've introduced a lot of confusing ambiguity in the project that makes it fun to explain. The name alone is [confusing](https://twitter.com/mxstbr/status/812028946682408962) but none of the options me and Danger came up with were free. Unpon realising that Danger was free, [I jumped on it](https://github.com/artsy/mobile/issues/31#issuecomment-118543364) together, and then [the anthropromophism](http://danger.systems/guides/faq.html#danger-keeps-getting-refered-to-as-quot-her-she-quot-what-gives) muddies the discussion even further.
...
This year I've been to: Milan, Oslo, Stockholm, Geneva, Zurich, Budapest, San Francisco, Novosirbirsk, Moscow and the Peak District. It's less than last year, which was less than 2014. I expect to do less in 2017.
...
We then took the Trans-Siberian railyway to Moscow, this is one of those "on everyone's bucket list" things that you don't get the chance to do without aiming travelling just for it. It was a 4 day train ride, where you can get off maybe once a day for an hour or two.
