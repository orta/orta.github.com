...
It's hard to remember the specifics of why I [wrote this](http://orta.io/rebase/impact/), but it was around the CocoaPods 1.0 launch where I was turning down a lot of offers to do things. It worried Danger.
...
[Alloy][] put forward that React Native, should be the way in which Artsy handles mobile.
...
-   [Stephen Universe](https://ashfurrow.com/blog/steven-universe-and-masculinity/)
...
People ask, so, Porn isn't really a thing on VR, it's pretty bad. The most interesting bit to me is that [PornHub is producing their own][pornhub]. It's a bit like when Netflix started making their own series. Could bring a lot of changes.
...
I [played TF2][tf2] for years. I played in leagues back when I was 21/22 but once I moved to Huddersfield (and left my Windows computer behind) I never really got back into these kind of games. Overwatch changed that. It offered a more fresh, modern take on the root concept of TF2 with a lot less machoism.
...
I do somewhere between 10-20 [code reviews][] a day. Danger makes the process of code review easier. By making it possible to automate parts of your team workflow. We wanted to be able to write CHANGELOGs, and add tiny, useful bits of process. We could do this by making project specific rules using Danger.

Danger started out solving one specific problem, and eventually became useful in many, many places. I built the start of Danger out of the the CocoaPods codebase in Ruby, and as we redefined what Artsy mobile looked like I started to sense that I needed a version that could run JavaScript. So I made a fork which [runs JavaScript][] - this lasted for a little bit, but felt uncanny valley.
...
This year I've been to: Milan, Oslo, Stockholm, Geneva, Zurich, Budapest, San Francisco, Novoskibirsk, Moscow and the Peak District. It's less than last year, which was less than 2014. I expect to do less in 2017.
...
One of the biggest highlights was a trip to Novosirbisk in Siberia with Danger. It was the last time I was nervous outside of asking Danger to marry me in 2016. I was the opening speaker, with a translator, to an audience of thousands. I didn't even get speaker's notes - hah! It all went really well though, and Matvey + crew were an amazing bunch.
