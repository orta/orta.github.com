...
It's hard to remember the specifics of why I [wrote this](http://orta.io/rebase/impact/), but it was around the CocoaPods 1.0 launch where I was turning down a lot of offers to do in order to ship a lot of software. It worried Danger.
...
People ask, so, Porn isn't really a thing on VR, it's pretty bad. The most interesting bit to me is that [PornHub is producing their own][pornhub] content. It's a bit like when Netflix started making their own series. Could bring a lot of changes.
