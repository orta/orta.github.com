...
experiences there. For a lot of folks, a job is just a job - but my work at Artsy really was a core part of my identity.
I grew alongside Artsy. I joined as a small-town developer doing remote feature-work on an throwaway app, hired on a
...
The TypeScript team is a different bag from the Artsy Engineering team. The TypeScript team is full of incredibly smart
engineers with an exceptional depth in compilers, type-theory and JavaScript's underlying warts. Months into joining
this team I'm regularly in over my head in conversations about how things work in different parts of the compiler. It's
likely to be many years, if ever, that I'll get a similar level of familiarity with the intrinsic (and essential)
complexity involved in a project like TypeScript.
