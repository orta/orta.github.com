...
You can grab a more advanced game using the text Adventure engine "here":/assets/files/iphone/MyBoots.zip and get an idea for just how deep you can go with that.
