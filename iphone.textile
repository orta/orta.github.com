...
h1(important). "First steps in OOP":http://orta.github.com/learn_ios
...
"!/assets/images/iphone/textadventure.jpg(Flippy stuff)!":/assets/files/iphone/TextAdventureStarter.zip


h2. But that's not all! 

You can grab a more advanced game using the text Adventure engine "here (Kierononononon Kwest)":/assets/files/iphone/KierononononQuest.zip and get an idea for just how deep you can go with that.
